...
- A three-dimensional RSOC multi-physics field model is established based on COMSOL to reveal the overshoot mechanism during dynamic operation 
- A bidirectional adaptive fuzzy control strategy is designed in combination with Simulink to achieve smooth regulation of mode switching 
